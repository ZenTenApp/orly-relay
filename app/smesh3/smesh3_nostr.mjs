// Package smesh3/nostr
// Generated by TinyJS — TinyGo JavaScript backend

import * as $rt from './$runtime/index.mjs';

import * as smesh3$crypto$sha256 from './smesh3_crypto_sha256.mjs';
import * as smesh3$helpers from './smesh3_helpers.mjs';

// Package-level variables

$rt.types.registerType('smesh3/nostr.Filter', {
  id: 'smesh3/nostr.Filter',
  kind: 'struct',
  methods: new Map(),
  fields: [
...
$rt.types.registerType('smesh3/nostr.Event', {
  id: 'smesh3/nostr.Event',
  kind: 'struct',
  methods: new Map(),
  fields: [
    ...
    { name: 'Tags', type: 'smesh3/nostr.Tags', tag: 'json:"tags"', embedded: false },
  ...
  while (true) {
    switch ($block) {
      ...
      case 9:
        ...
        break;
      case 10:
        $t42_43 = smesh3$helpers.JsonString($t31_32);
...
$rt.types.getType('smesh3/nostr.Tag')?.methods?.set('Key', Tag$Key);
...
$rt.types.getType('smesh3/nostr.Tag')?.methods?.set('Marker', Tag$Marker);
...
$rt.types.getType('smesh3/nostr.Tag')?.methods?.set('Relay', Tag$Relay);
...
$rt.types.getType('smesh3/nostr.Tag')?.methods?.set('Value', Tag$Value);
...
$rt.types.getType('smesh3/nostr.Tags')?.methods?.set('ContainsValue', Tags$ContainsValue);
...
$rt.types.getType('smesh3/nostr.Tags')?.methods?.set('GetAll', Tags$GetAll);
...
$rt.types.getType('smesh3/nostr.Tags')?.methods?.set('GetD', Tags$GetD);
...
$rt.types.getType('smesh3/nostr.Tags')?.methods?.set('GetFirst', Tags$GetFirst);
...
$rt.types.getType('smesh3/nostr.Filter')?.methods?.set('Matches', Filter$Matches);
...
$rt.types.getType('smesh3/nostr.Filter')?.methods?.set('Serialize', Filter$Serialize);
...
$rt.types.getType('smesh3/nostr.Event')?.methods?.set('CheckID', Event$CheckID);
...
$rt.types.getType('smesh3/nostr.Event')?.methods?.set('ComputeID', Event$ComputeID);
export function Event$Serialize(e) {
  ...
  $t4_5 = $t3_4.$get();
  $t5_6 = smesh3$helpers.JsonString($t4_5);
  ...
  $t12_13 = $t11_12.$get();
  $t13_14 = smesh3$helpers.Itoa($t12_13);
  ...
  $t20_21 = $t19_20.$get();
  $t21_22 = $t20_21;
  $t22_23 = smesh3$helpers.Itoa($t21_22);
  ...
  $t36_37 = $t35_36.$get();
  $t37_38 = smesh3$helpers.JsonString($t36_37);
...
$rt.types.getType('smesh3/nostr.Event')?.methods?.set('Serialize', Event$Serialize);
