...
export const StorageKey = {
  ...
  FALLBACK_RELAY_COUNT: 'fallbackRelayCount',
  ...
  AUTO_INSERT_NEW_NOTES: 'autoInsertNewNotes',
...
/**
 * Recommended search relays that users can opt into.
 * These are NOT used by default - search is opt-in to protect privacy.
 * Users must explicitly configure search relays or accept these recommendations.
 */
