...
const file_orlydb_v1_service_proto_rawDesc = "" +
	...
	"\x05error\x18\x02 \x01(\tR\x05error2\xce/\n" +
...
var file_orlydb_v1_service_proto_msgTypes = make([]protoimpl.MessageInfo, 95)
var file_orlydb_v1_service_proto_goTypes = []any{
	...
	nil,                                        // 94: orlydb.v1.CypherReadRequest.ParamsEntry
	(*Event)(nil),                              // 95: orlydb.v1.Event
	(*Filter)(nil),                             // 96: orlydb.v1.Filter
	(*Range)(nil),                              // 97: orlydb.v1.Range
	(*Empty)(nil),                              // 98: orlydb.v1.Empty
	(*SerialList)(nil),                         // 99: orlydb.v1.SerialList
	(*EventBatch)(nil),                         // 100: orlydb.v1.EventBatch
	(*IdPkTsList)(nil),                         // 101: orlydb.v1.IdPkTsList
	(*EventMap)(nil),                           // 102: orlydb.v1.EventMap
	(*SerialMap)(nil),                          // 103: orlydb.v1.SerialMap
	(*IdPkTs)(nil),                             // 104: orlydb.v1.IdPkTs
	(*Subscription)(nil),                       // 105: orlydb.v1.Subscription
	(*PaymentList)(nil),                        // 106: orlydb.v1.PaymentList
	(*NIP43Membership)(nil),                    // 107: orlydb.v1.NIP43Membership
	(*PubkeyList)(nil),                         // 108: orlydb.v1.PubkeyList
}
var file_orlydb_v1_service_proto_depIdxs = []int32{
	95,  // 0: orlydb.v1.SaveEventRequest.event:type_name -> orlydb.v1.Event
	96,  // 1: orlydb.v1.GetSerialsFromFilterRequest.filter:type_name -> orlydb.v1.Filter
	95,  // 2: orlydb.v1.WouldReplaceEventRequest.event:type_name -> orlydb.v1.Event
	96,  // 3: orlydb.v1.QueryEventsRequest.filter:type_name -> orlydb.v1.Filter
	96,  // 4: orlydb.v1.QueryEventsWithOptionsRequest.filter:type_name -> orlydb.v1.Filter
	95,  // 5: orlydb.v1.FetchEventBySerialResponse.event:type_name -> orlydb.v1.Event
	97,  // 6: orlydb.v1.GetSerialsByRangeRequest.range:type_name -> orlydb.v1.Range
	95,  // 7: orlydb.v1.DeleteEventBySerialRequest.event:type_name -> orlydb.v1.Event
	95,  // 8: orlydb.v1.ProcessDeleteRequest.event:type_name -> orlydb.v1.Event
	95,  // 9: orlydb.v1.CheckForDeletedRequest.event:type_name -> orlydb.v1.Event
	96,  // 10: orlydb.v1.GetCachedJSONRequest.filter:type_name -> orlydb.v1.Filter
	96,  // 11: orlydb.v1.CacheMarshaledJSONRequest.filter:type_name -> orlydb.v1.Filter
	96,  // 12: orlydb.v1.GetCachedEventsRequest.filter:type_name -> orlydb.v1.Filter
	95,  // 13: orlydb.v1.GetCachedEventsResponse.events:type_name -> orlydb.v1.Event
	96,  // 14: orlydb.v1.CacheEventsRequest.filter:type_name -> orlydb.v1.Filter
	95,  // 15: orlydb.v1.CacheEventsRequest.events:type_name -> orlydb.v1.Event
	...
	94,  // 19: orlydb.v1.CypherReadRequest.params:type_name -> orlydb.v1.CypherReadRequest.ParamsEntry
	98,  // 20: orlydb.v1.DatabaseService.GetPath:input_type -> orlydb.v1.Empty
	98,  // 21: orlydb.v1.DatabaseService.Sync:input_type -> orlydb.v1.Empty
	98,  // 22: orlydb.v1.DatabaseService.Ready:input_type -> orlydb.v1.Empty
	2,   // 23: orlydb.v1.DatabaseService.SetLogLevel:input_type -> orlydb.v1.SetLogLevelRequest
	3,   // 24: orlydb.v1.DatabaseService.SaveEvent:input_type -> orlydb.v1.SaveEventRequest
	5,   // 25: orlydb.v1.DatabaseService.GetSerialsFromFilter:input_type -> orlydb.v1.GetSerialsFromFilterRequest
	6,   // 26: orlydb.v1.DatabaseService.WouldReplaceEvent:input_type -> orlydb.v1.WouldReplaceEventRequest
	8,   // 27: orlydb.v1.DatabaseService.QueryEvents:input_type -> orlydb.v1.QueryEventsRequest
	8,   // 28: orlydb.v1.DatabaseService.QueryAllVersions:input_type -> orlydb.v1.QueryEventsRequest
	9,   // 29: orlydb.v1.DatabaseService.QueryEventsWithOptions:input_type -> orlydb.v1.QueryEventsWithOptionsRequest
	10,  // 30: orlydb.v1.DatabaseService.QueryDeleteEventsByTargetId:input_type -> orlydb.v1.QueryDeleteEventsByTargetIdRequest
	8,   // 31: orlydb.v1.DatabaseService.QueryForSerials:input_type -> orlydb.v1.QueryEventsRequest
	8,   // 32: orlydb.v1.DatabaseService.QueryForIds:input_type -> orlydb.v1.QueryEventsRequest
	8,   // 33: orlydb.v1.DatabaseService.CountEvents:input_type -> orlydb.v1.QueryEventsRequest
	12,  // 34: orlydb.v1.DatabaseService.FetchEventBySerial:input_type -> orlydb.v1.FetchEventBySerialRequest
	14,  // 35: orlydb.v1.DatabaseService.FetchEventsBySerials:input_type -> orlydb.v1.FetchEventsBySerialRequest
	15,  // 36: orlydb.v1.DatabaseService.GetSerialById:input_type -> orlydb.v1.GetSerialByIdRequest
	17,  // 37: orlydb.v1.DatabaseService.GetSerialsByIds:input_type -> orlydb.v1.GetSerialsByIdsRequest
	18,  // 38: orlydb.v1.DatabaseService.GetSerialsByRange:input_type -> orlydb.v1.GetSerialsByRangeRequest
	19,  // 39: orlydb.v1.DatabaseService.GetFullIdPubkeyBySerial:input_type -> orlydb.v1.GetFullIdPubkeyBySerialRequest
	20,  // 40: orlydb.v1.DatabaseService.GetFullIdPubkeyBySerials:input_type -> orlydb.v1.GetFullIdPubkeyBySerialsRequest
	21,  // 41: orlydb.v1.DatabaseService.DeleteEvent:input_type -> orlydb.v1.DeleteEventRequest
	22,  // 42: orlydb.v1.DatabaseService.DeleteEventBySerial:input_type -> orlydb.v1.DeleteEventBySerialRequest
	98,  // 43: orlydb.v1.DatabaseService.DeleteExpired:input_type -> orlydb.v1.Empty
	23,  // 44: orlydb.v1.DatabaseService.ProcessDelete:input_type -> orlydb.v1.ProcessDeleteRequest
	24,  // 45: orlydb.v1.DatabaseService.CheckForDeleted:input_type -> orlydb.v1.CheckForDeletedRequest
	25,  // 46: orlydb.v1.DatabaseService.Import:input_type -> orlydb.v1.ImportChunk
	27,  // 47: orlydb.v1.DatabaseService.Export:input_type -> orlydb.v1.ExportRequest
	29,  // 48: orlydb.v1.DatabaseService.ImportEventsFromStrings:input_type -> orlydb.v1.ImportEventsFromStringsRequest
	98,  // 49: orlydb.v1.DatabaseService.GetRelayIdentitySecret:input_type -> orlydb.v1.Empty
	31,  // 50: orlydb.v1.DatabaseService.SetRelayIdentitySecret:input_type -> orlydb.v1.SetRelayIdentitySecretRequest
	98,  // 51: orlydb.v1.DatabaseService.GetOrCreateRelayIdentitySecret:input_type -> orlydb.v1.Empty
	32,  // 52: orlydb.v1.DatabaseService.SetMarker:input_type -> orlydb.v1.SetMarkerRequest
	33,  // 53: orlydb.v1.DatabaseService.GetMarker:input_type -> orlydb.v1.GetMarkerRequest
	35,  // 54: orlydb.v1.DatabaseService.HasMarker:input_type -> orlydb.v1.HasMarkerRequest
	37,  // 55: orlydb.v1.DatabaseService.DeleteMarker:input_type -> orlydb.v1.DeleteMarkerRequest
	38,  // 56: orlydb.v1.DatabaseService.GetSubscription:input_type -> orlydb.v1.GetSubscriptionRequest
	39,  // 57: orlydb.v1.DatabaseService.IsSubscriptionActive:input_type -> orlydb.v1.IsSubscriptionActiveRequest
	41,  // 58: orlydb.v1.DatabaseService.ExtendSubscription:input_type -> orlydb.v1.ExtendSubscriptionRequest
	42,  // 59: orlydb.v1.DatabaseService.RecordPayment:input_type -> orlydb.v1.RecordPaymentRequest
	43,  // 60: orlydb.v1.DatabaseService.GetPaymentHistory:input_type -> orlydb.v1.GetPaymentHistoryRequest
	44,  // 61: orlydb.v1.DatabaseService.ExtendBlossomSubscription:input_type -> orlydb.v1.ExtendBlossomSubscriptionRequest
	45,  // 62: orlydb.v1.DatabaseService.GetBlossomStorageQuota:input_type -> orlydb.v1.GetBlossomStorageQuotaRequest
	47,  // 63: orlydb.v1.DatabaseService.IsFirstTimeUser:input_type -> orlydb.v1.IsFirstTimeUserRequest
	49,  // 64: orlydb.v1.DatabaseService.AddNIP43Member:input_type -> orlydb.v1.AddNIP43MemberRequest
	50,  // 65: orlydb.v1.DatabaseService.RemoveNIP43Member:input_type -> orlydb.v1.RemoveNIP43MemberRequest
	51,  // 66: orlydb.v1.DatabaseService.IsNIP43Member:input_type -> orlydb.v1.IsNIP43MemberRequest
	53,  // 67: orlydb.v1.DatabaseService.GetNIP43Membership:input_type -> orlydb.v1.GetNIP43MembershipRequest
	98,  // 68: orlydb.v1.DatabaseService.GetAllNIP43Members:input_type -> orlydb.v1.Empty
	54,  // 69: orlydb.v1.DatabaseService.StoreInviteCode:input_type -> orlydb.v1.StoreInviteCodeRequest
	55,  // 70: orlydb.v1.DatabaseService.ValidateInviteCode:input_type -> orlydb.v1.ValidateInviteCodeRequest
	57,  // 71: orlydb.v1.DatabaseService.DeleteInviteCode:input_type -> orlydb.v1.DeleteInviteCodeRequest
	58,  // 72: orlydb.v1.DatabaseService.PublishNIP43MembershipEvent:input_type -> orlydb.v1.PublishNIP43MembershipEventRequest
	59,  // 73: orlydb.v1.DatabaseService.GetCachedJSON:input_type -> orlydb.v1.GetCachedJSONRequest
	61,  // 74: orlydb.v1.DatabaseService.CacheMarshaledJSON:input_type -> orlydb.v1.CacheMarshaledJSONRequest
	62,  // 75: orlydb.v1.DatabaseService.GetCachedEvents:input_type -> orlydb.v1.GetCachedEventsRequest
	64,  // 76: orlydb.v1.DatabaseService.CacheEvents:input_type -> orlydb.v1.CacheEventsRequest
	98,  // 77: orlydb.v1.DatabaseService.InvalidateQueryCache:input_type -> orlydb.v1.Empty
	65,  // 78: orlydb.v1.DatabaseService.RecordEventAccess:input_type -> orlydb.v1.RecordEventAccessRequest
	66,  // 79: orlydb.v1.DatabaseService.GetEventAccessInfo:input_type -> orlydb.v1.GetEventAccessInfoRequest
	68,  // 80: orlydb.v1.DatabaseService.GetLeastAccessedEvents:input_type -> orlydb.v1.GetLeastAccessedEventsRequest
	73,  // 81: orlydb.v1.DatabaseService.SaveBlob:input_type -> orlydb.v1.SaveBlobRequest
	74,  // 82: orlydb.v1.DatabaseService.SaveBlobMetadata:input_type -> orlydb.v1.SaveBlobMetadataRequest
	75,  // 83: orlydb.v1.DatabaseService.GetBlob:input_type -> orlydb.v1.GetBlobRequest
	77,  // 84: orlydb.v1.DatabaseService.HasBlob:input_type -> orlydb.v1.HasBlobRequest
	79,  // 85: orlydb.v1.DatabaseService.DeleteBlob:input_type -> orlydb.v1.DeleteBlobRequest
	80,  // 86: orlydb.v1.DatabaseService.ListBlobs:input_type -> orlydb.v1.ListBlobsRequest
	82,  // 87: orlydb.v1.DatabaseService.GetBlobMetadata:input_type -> orlydb.v1.GetBlobMetadataRequest
	83,  // 88: orlydb.v1.DatabaseService.GetTotalBlobStorageUsed:input_type -> orlydb.v1.GetTotalBlobStorageUsedRequest
	85,  // 89: orlydb.v1.DatabaseService.SaveBlobReport:input_type -> orlydb.v1.SaveBlobReportRequest
	98,  // 90: orlydb.v1.DatabaseService.ListAllBlobUserStats:input_type -> orlydb.v1.Empty
	98,  // 91: orlydb.v1.DatabaseService.ReconcileBlobMetadata:input_type -> orlydb.v1.Empty
	98,  // 92: orlydb.v1.DatabaseService.ListAllBlobs:input_type -> orlydb.v1.Empty
	89,  // 93: orlydb.v1.DatabaseService.GetThumbnail:input_type -> orlydb.v1.GetThumbnailRequest
	91,  // 94: orlydb.v1.DatabaseService.SaveThumbnail:input_type -> orlydb.v1.SaveThumbnailRequest
	69,  // 95: orlydb.v1.DatabaseService.EventIdsBySerial:input_type -> orlydb.v1.EventIdsBySerialRequest
	98,  // 96: orlydb.v1.DatabaseService.RunMigrations:input_type -> orlydb.v1.Empty
	92,  // 97: orlydb.v1.DatabaseService.ExecuteCypherRead:input_type -> orlydb.v1.CypherReadRequest
	0,   // 98: orlydb.v1.DatabaseService.GetPath:output_type -> orlydb.v1.PathResponse
	98,  // 99: orlydb.v1.DatabaseService.Sync:output_type -> orlydb.v1.Empty
	1,   // 100: orlydb.v1.DatabaseService.Ready:output_type -> orlydb.v1.ReadyResponse
	98,  // 101: orlydb.v1.DatabaseService.SetLogLevel:output_type -> orlydb.v1.Empty
	4,   // 102: orlydb.v1.DatabaseService.SaveEvent:output_type -> orlydb.v1.SaveEventResponse
	99,  // 103: orlydb.v1.DatabaseService.GetSerialsFromFilter:output_type -> orlydb.v1.SerialList
	7,   // 104: orlydb.v1.DatabaseService.WouldReplaceEvent:output_type -> orlydb.v1.WouldReplaceEventResponse
	100, // 105: orlydb.v1.DatabaseService.QueryEvents:output_type -> orlydb.v1.EventBatch
	100, // 106: orlydb.v1.DatabaseService.QueryAllVersions:output_type -> orlydb.v1.EventBatch
	100, // 107: orlydb.v1.DatabaseService.QueryEventsWithOptions:output_type -> orlydb.v1.EventBatch
	100, // 108: orlydb.v1.DatabaseService.QueryDeleteEventsByTargetId:output_type -> orlydb.v1.EventBatch
	99,  // 109: orlydb.v1.DatabaseService.QueryForSerials:output_type -> orlydb.v1.SerialList
	101, // 110: orlydb.v1.DatabaseService.QueryForIds:output_type -> orlydb.v1.IdPkTsList
	11,  // 111: orlydb.v1.DatabaseService.CountEvents:output_type -> orlydb.v1.CountEventsResponse
	13,  // 112: orlydb.v1.DatabaseService.FetchEventBySerial:output_type -> orlydb.v1.FetchEventBySerialResponse
	102, // 113: orlydb.v1.DatabaseService.FetchEventsBySerials:output_type -> orlydb.v1.EventMap
	16,  // 114: orlydb.v1.DatabaseService.GetSerialById:output_type -> orlydb.v1.GetSerialByIdResponse
	103, // 115: orlydb.v1.DatabaseService.GetSerialsByIds:output_type -> orlydb.v1.SerialMap
	99,  // 116: orlydb.v1.DatabaseService.GetSerialsByRange:output_type -> orlydb.v1.SerialList
	104, // 117: orlydb.v1.DatabaseService.GetFullIdPubkeyBySerial:output_type -> orlydb.v1.IdPkTs
	101, // 118: orlydb.v1.DatabaseService.GetFullIdPubkeyBySerials:output_type -> orlydb.v1.IdPkTsList
	98,  // 119: orlydb.v1.DatabaseService.DeleteEvent:output_type -> orlydb.v1.Empty
	98,  // 120: orlydb.v1.DatabaseService.DeleteEventBySerial:output_type -> orlydb.v1.Empty
	98,  // 121: orlydb.v1.DatabaseService.DeleteExpired:output_type -> orlydb.v1.Empty
	98,  // 122: orlydb.v1.DatabaseService.ProcessDelete:output_type -> orlydb.v1.Empty
	98,  // 123: orlydb.v1.DatabaseService.CheckForDeleted:output_type -> orlydb.v1.Empty
	26,  // 124: orlydb.v1.DatabaseService.Import:output_type -> orlydb.v1.ImportResponse
	28,  // 125: orlydb.v1.DatabaseService.Export:output_type -> orlydb.v1.ExportChunk
	26,  // 126: orlydb.v1.DatabaseService.ImportEventsFromStrings:output_type -> orlydb.v1.ImportResponse
	30,  // 127: orlydb.v1.DatabaseService.GetRelayIdentitySecret:output_type -> orlydb.v1.GetRelayIdentitySecretResponse
	98,  // 128: orlydb.v1.DatabaseService.SetRelayIdentitySecret:output_type -> orlydb.v1.Empty
	30,  // 129: orlydb.v1.DatabaseService.GetOrCreateRelayIdentitySecret:output_type -> orlydb.v1.GetRelayIdentitySecretResponse
	98,  // 130: orlydb.v1.DatabaseService.SetMarker:output_type -> orlydb.v1.Empty
	34,  // 131: orlydb.v1.DatabaseService.GetMarker:output_type -> orlydb.v1.GetMarkerResponse
	36,  // 132: orlydb.v1.DatabaseService.HasMarker:output_type -> orlydb.v1.HasMarkerResponse
	98,  // 133: orlydb.v1.DatabaseService.DeleteMarker:output_type -> orlydb.v1.Empty
	105, // 134: orlydb.v1.DatabaseService.GetSubscription:output_type -> orlydb.v1.Subscription
	40,  // 135: orlydb.v1.DatabaseService.IsSubscriptionActive:output_type -> orlydb.v1.IsSubscriptionActiveResponse
	98,  // 136: orlydb.v1.DatabaseService.ExtendSubscription:output_type -> orlydb.v1.Empty
	98,  // 137: orlydb.v1.DatabaseService.RecordPayment:output_type -> orlydb.v1.Empty
	106, // 138: orlydb.v1.DatabaseService.GetPaymentHistory:output_type -> orlydb.v1.PaymentList
	98,  // 139: orlydb.v1.DatabaseService.ExtendBlossomSubscription:output_type -> orlydb.v1.Empty
	46,  // 140: orlydb.v1.DatabaseService.GetBlossomStorageQuota:output_type -> orlydb.v1.GetBlossomStorageQuotaResponse
	48,  // 141: orlydb.v1.DatabaseService.IsFirstTimeUser:output_type -> orlydb.v1.IsFirstTimeUserResponse
	98,  // 142: orlydb.v1.DatabaseService.AddNIP43Member:output_type -> orlydb.v1.Empty
	98,  // 143: orlydb.v1.DatabaseService.RemoveNIP43Member:output_type -> orlydb.v1.Empty
	52,  // 144: orlydb.v1.DatabaseService.IsNIP43Member:output_type -> orlydb.v1.IsNIP43MemberResponse
	107, // 145: orlydb.v1.DatabaseService.GetNIP43Membership:output_type -> orlydb.v1.NIP43Membership
	108, // 146: orlydb.v1.DatabaseService.GetAllNIP43Members:output_type -> orlydb.v1.PubkeyList
	98,  // 147: orlydb.v1.DatabaseService.StoreInviteCode:output_type -> orlydb.v1.Empty
	56,  // 148: orlydb.v1.DatabaseService.ValidateInviteCode:output_type -> orlydb.v1.ValidateInviteCodeResponse
	98,  // 149: orlydb.v1.DatabaseService.DeleteInviteCode:output_type -> orlydb.v1.Empty
	98,  // 150: orlydb.v1.DatabaseService.PublishNIP43MembershipEvent:output_type -> orlydb.v1.Empty
	60,  // 151: orlydb.v1.DatabaseService.GetCachedJSON:output_type -> orlydb.v1.GetCachedJSONResponse
	98,  // 152: orlydb.v1.DatabaseService.CacheMarshaledJSON:output_type -> orlydb.v1.Empty
	63,  // 153: orlydb.v1.DatabaseService.GetCachedEvents:output_type -> orlydb.v1.GetCachedEventsResponse
	98,  // 154: orlydb.v1.DatabaseService.CacheEvents:output_type -> orlydb.v1.Empty
	98,  // 155: orlydb.v1.DatabaseService.InvalidateQueryCache:output_type -> orlydb.v1.Empty
	98,  // 156: orlydb.v1.DatabaseService.RecordEventAccess:output_type -> orlydb.v1.Empty
	67,  // 157: orlydb.v1.DatabaseService.GetEventAccessInfo:output_type -> orlydb.v1.GetEventAccessInfoResponse
	99,  // 158: orlydb.v1.DatabaseService.GetLeastAccessedEvents:output_type -> orlydb.v1.SerialList
	98,  // 159: orlydb.v1.DatabaseService.SaveBlob:output_type -> orlydb.v1.Empty
	98,  // 160: orlydb.v1.DatabaseService.SaveBlobMetadata:output_type -> orlydb.v1.Empty
	76,  // 161: orlydb.v1.DatabaseService.GetBlob:output_type -> orlydb.v1.GetBlobResponse
	78,  // 162: orlydb.v1.DatabaseService.HasBlob:output_type -> orlydb.v1.HasBlobResponse
	98,  // 163: orlydb.v1.DatabaseService.DeleteBlob:output_type -> orlydb.v1.Empty
	81,  // 164: orlydb.v1.DatabaseService.ListBlobs:output_type -> orlydb.v1.ListBlobsResponse
	71,  // 165: orlydb.v1.DatabaseService.GetBlobMetadata:output_type -> orlydb.v1.BlobMetadata
	84,  // 166: orlydb.v1.DatabaseService.GetTotalBlobStorageUsed:output_type -> orlydb.v1.GetTotalBlobStorageUsedResponse
	98,  // 167: orlydb.v1.DatabaseService.SaveBlobReport:output_type -> orlydb.v1.Empty
	87,  // 168: orlydb.v1.DatabaseService.ListAllBlobUserStats:output_type -> orlydb.v1.ListAllBlobUserStatsResponse
	88,  // 169: orlydb.v1.DatabaseService.ReconcileBlobMetadata:output_type -> orlydb.v1.ReconcileBlobMetadataResponse
	81,  // 170: orlydb.v1.DatabaseService.ListAllBlobs:output_type -> orlydb.v1.ListBlobsResponse
	90,  // 171: orlydb.v1.DatabaseService.GetThumbnail:output_type -> orlydb.v1.GetThumbnailResponse
	98,  // 172: orlydb.v1.DatabaseService.SaveThumbnail:output_type -> orlydb.v1.Empty
	70,  // 173: orlydb.v1.DatabaseService.EventIdsBySerial:output_type -> orlydb.v1.EventIdsBySerialResponse
	98,  // 174: orlydb.v1.DatabaseService.RunMigrations:output_type -> orlydb.v1.Empty
	93,  // 175: orlydb.v1.DatabaseService.ExecuteCypherRead:output_type -> orlydb.v1.CypherReadResponse
	98,  // [98:176] is the sub-list for method output_type
	20,  // [20:98] is the sub-list for method input_type
